...
T deserializeJsonDocument<T>(DocumentSnapshot<Map<String, dynamic>> document, DocumentDeserializer<T> deserializer) {
  final json = document.data()!..['id'] = document.id;
  return deserializer(json);
}

Map<String, dynamic> serializeJsonDocument<T>(T data, DocumentSerializer<T> serializer) {
